...
# -----------------------------------------------------------------------------
EXAMPLES = examples/dig-demo examples/zauberschloss examples/grogs-revenge examples/scroller-demo examples/invaders examples/nebelkrone examples/gamebook-template examples/loderunner examples/w25q128-test examples/w25q80-test examples/w25q-scan examples/w25q128-scan examples/flash-pin-blink
